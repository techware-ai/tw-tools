...
# ── SECTION 7: WINDOWS VERSION & BUILD ───────────────────────
Write-Host ""
...
# Flag outdated builds
$outdatedBuilds = @("19041","19042","19043","19044","22000","22621")
...
# ── SECTION 8: RECENT DRIVER CHANGES ─────────────────────────
Write-Host ""
...
$driverInstalls = Get-WinEvent -FilterHashtable @{
    LogName   = 'System'
    Id        = 7036
    StartTime = $sevenDaysAgo
} -ErrorAction SilentlyContinue | Where-Object { $_.Message -match "driver" } |
